...
public class SinkDiscoveryUtils {
  /**
   * The method loop through all methods and classes for the target project and discover all sink
   * methods existed in the project.
   *
   ...
   */
  public static List<SootMethod> discoverAllSinks(
    ...
    Map<SootMethod, List<SootMethod>> parentMap =
        BlockGraphInfoUtils.getAllMethodParents(projectClassMethodMap);
